...
astFromSexpr :: SExpr -> Either DT.Text OldAst
...
processDefine :: FuncTable -> OldEnv -> OldAst ->
...
processCallOrEval :: FuncTable -> OldEnv -> OldAst ->
    Either DT.Text (FuncTable, OldEnv, Maybe OldAst)
...
processSExpr :: FuncTable -> OldEnv -> SExpr ->
    Either DT.Text (FuncTable, OldEnv, Maybe OldAst)
